...
html *
{
 ...
 <div class="box">
     		<div class="form_row_l2" id="form_invoice_client_">
                		{if $company->profile->company_pict_preview != ''}{assign var="url" value=$company->profile->company_pict_preview}<img src="/profiles/tmp/company/pictures/{$url}" boder="0" />{else}<img src="/profiles/tmp/company/pictures/profile.png" boder="0" />{/if}
    	 		 </div>
	...
	<div class="box" id="form_box_">
      <div class="form_row_l" id="form_invoice_company_">
		...
		{assign var='counter3' value=0}
    	    {foreach from=$addresses item=address}{if $counter3 == 0}{assign var='counter3' value=$counter3 +1}
	...
	{assign var='counter' value=0}
	 ...
	 {/if}
      ...
      <div class="form_row_r" id="form_invoice_company_">
			...
			<div class="form_row_r_1">Desc. ({$invoice->profile->discount} &#37;):</div>
