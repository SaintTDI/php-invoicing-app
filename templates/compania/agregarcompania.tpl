...
<head><script type="text/javascript" src="/js/jquery1_10.js"></script>
...
{/literal}</head>
<body>
<form method="post" id="comp_id" action="{geturl action='agregarcompania'}?id={$fp->company->getId()}&id2={$fp->address->getId()}&doc_type={$smarty.get.doc_type}&comp_doc_type={$smarty.get.comp_doc_type}&contact_id={$smarty.get.contact_id}&comp_type={$smarty.get.comp_type}" enctype="multipart/form-data">
    {if $fp->hasError()}
        		<div class="error">
   ...
   {/literal *}
    <div class="row" id="form_thecompany_container">
        ...
        <input type="text" id="form_company" name="thecompany" value="{$smarty.post.thecompany}" placeholder="Ej: Google, SL"/>
    ...
    <div class="row" id="form_identification_container">
        ...
        <input type="text" id="form_identification" name="identification" value="{$smarty.post.identification}" placeholder="Ej: J-222-222-8"/>
        ...
        {foreach from=$fp->companyProfile key='key' item='label'}
                {if $label == 'Industry'}
     				...
     				<label for="form_industry">&Aacute;rea o Sector:</label>
        				<select id="form_industry" name="company_industry"/>
       						...
       						<option value="abogacia" {if $smarty.post.company_industry == 'abogacia'} selected="selected" {/if}>Abogac&iacute;a</option>
							<option value="aeroespacial" {if $smarty.post.company_industry == 'aeroespacial'} selected="selected" {/if}>Aeroespacial</option>
        						<option value="aerea" {if $smarty.post.company_industry == 'aerea'} selected="selected" {/if}>Aerea</option>
        						<option value="arquitectura" {if $smarty.post.company_industry == 'arquitectura'} selected="selected" {/if}>Arquitectura</option>
        						<option value="banca" {if $smarty.post.company_industry == 'banca'} selected="selected" {/if}>Banca</option>
        						<option value="bienes" {if $smarty.post.company_industry == 'bienes'} selected="selected" {/if}>Bienes de Consumo</option>
        						<option value="diseno" {if $smarty.post.company_industry == 'diseno'} selected="selected" {/if}>Dise&ntilde;o</option>
        						<option value="distribuidor" {if $smarty.post.company_industry == 'distribuidor'} selected="selected" {/if}>Distribuidor</option>
        						<option value="defensa" {if $smarty.post.company_industry == 'defensa'} selected="selected" {/if}>Defensa</option>
        						<option value="energia" {if $smarty.post.company_industry == 'energia'} selected="selected" {/if}>Energ&iacute;a</option>
        						<option value="manofactura" {if $smarty.post.company_industry == 'manofactura'} selected="selected" {/if}>Manofactura</option>
        						<option value="mineria" {if $smarty.post.company_industry == 'mineria'} selected="selected" {/if}>Miner&iacute;a</option>
        						<option value="retail" {if $smarty.post.company_industry == 'retail'} selected="selected" {/if}>Retail/Tienda</option>
        						<option value="publico" {if $smarty.post.company_industry == 'publico'} selected="selected" {/if}>Sector P&uacute;blico</option>
        						<option value="seguros" {if $smarty.post.company_industry == 'seguros'} selected="selected" {/if}>Seguros</option>
        						<option value="seguridad" {if $smarty.post.company_industry == 'seguridad'} selected="selected" {/if}>Seguridad</option>
        						...
        						<option value="tecnologia" {if $smarty.post.company_industry == 'tecnologia'} selected="selected" {/if}>Tecnolog&iacute;as de la Informaci&oacute;n</option>
                ...
                {elseif $label == 'Specialty'}
						...
						<input type="text" id="form_{$key}" maxlength="200" name="{$key}" value="{$smarty.post.$key}"  placeholder="Ej: Branding y Mercadeo"/> 
    ...
    <div class="row" id="form_street_company_container">
        ...
        <input type="text" id="form_street" name="street" value="{$smarty.post.street}" placeholder="Calle o Avenida"/>
    ...
    <div class="row" id="form_house_company_container">
        ...
        <input type="text" id="form_house" name="house" value="{$smarty.post.house}" placeholder="N&uacute;mero, Casa o Edificio"/>
        {include file="lib/error.tpl" error=$fp->getError('house')}
    </div>
               
    <div class="row" id="form_neighbourhood_company_container">
        <label for="form_neighbourhood_company">Municipio o Sector:</label>
        <input type="text" id="form_neighbourhood" name="neighbourhood" value="{$smarty.post.neighbourhood}" placeholder="Municipio o Sector"/>
        {include file="lib/error.tpl" error=$fp->getError('neighbourhood')}
    </div>
    
    <div class="row" id="form_city_company_container">
        <label for="form_city_company">Ciudad:</label>
        <input type="text" id="form_city" name="city" value="{$smarty.post.city}" placeholder="Ciudad"/>
        {include file="lib/error.tpl" error=$fp->getError('city')}
    </div>
    
    <div class="row" id="form_province_company_container">
        <label for="form_province_company">Provincia o Cant&oacute;n:</label>
        <input type="text" id="form_province" name="province" value="{$smarty.post.province}" placeholder="Provincia o Cant&oacute;n"/>
    ...
    <div class="row" id="form_postal_code_company_container">
        ...
        <input type="text" id="form_postal" name="postal_code" value="{$smarty.post.postal_code}" placeholder="C&oacute;digo Postal"/>
    ...
    <input type="hidden" id="form_doc_type" name="doc_type" value="{$smarty.get.doc_type}" />
    <input type="hidden" id="form_comp_doc_type" name="comp_doc_type" value="{$smarty.get.comp_doc_type}" />
    <input type="hidden" id="doc_id" name="doc_id" value="{$smarty.get.id}" />
    <input type="hidden" id="form_contact_id" name="contact_id" value="{$smarty.get.contact_id}" />
  
    <div class="row" id="form_email_container">
        <label for="form_email">Email Principal <strong>&#x28;&#x2A;&#x29;</strong>:</label>
        <input type="text" id="form_email" name="email_c" value="{$smarty.post.email_c}" placeholder="Ej: ejemplo@webproadmin.co"/>
    ...
    *}
    <input type="hidden" id="form_email2" name="email2" value="{$smarty.post.email2}" />
     ...
     <div class="row" id="form_{$key}_container">
     	{if $label == 'Website'}
     		...
     		<input class="social" type="text" id="form_{$key}" maxlength="200" name="{$key}" value="{$smarty.post.$key}" placeholder="Ej: pagina.com"/>   
    		    {include file="lib/error.tpl" error=$fp->getError($key)}
    		{elseif $label == 'Twitter'}
     		...
     		<input class="social" type="text" id="form_{$key}" maxlength="200" name="{$key}" value="{$smarty.post.$key}"  placeholder="Ej: usuario"/>   
    		    {include file="lib/error.tpl" error=$fp->getError($key)}
      	{elseif $label == 'Address'}
     		<input type="hidden" id="company_address" name="company_address" value="{$smarty.get.id2}" />
    		    {include file="lib/error.tpl" error=$fp->getError($key)}
     	{/if}
     </div>
     {/foreach}
    ...
    <div class="row" id="form_phone_container">
        ...
        <input type="text" id="form_phone_p1" name="phone" value="{$smarty.post.phone}" onkeypress='validate(event)' placeholder="Tel&eacute;fono"/>
    ...
    <div class="row" id="form_phone2_container">
        ...
        <input type="text" id="form_phone_p2" name="phone2" value="{$smarty.post.phone2}" onkeypress='validate(event)' placeholder="Tel&eacute;fono"/>
    ...
    <div class="row" id="form_fax_container">
        ...
        <input type="text" id="form_phone_fax" name="fax" value="{$smarty.post.fax}" onkeypress='validate(event)' placeholder="Tel&eacute;fono"/>
    ...
    <div class="row" id="form_company_relationship">
        ...
        <select id="form_company_relationship" name="relationship"/>
       		<option value="" {if $smarty.get.comp_type == ''} selected="selected" {/if}>Seleccione...</option>
			<option value="proveedor" {if $smarty.get.comp_type == 'proveedor'} selected="selected" {/if}>Proveedor</option>
        		<option value="cliente" {if $smarty.get.comp_type == 'cliente'} selected="selected" {/if}>Cliente</option>
        		<option value="potencial" {if $smarty.get.comp_type == 'potencial'} selected="selected" {/if}>Cliente Potencial</option>
        		<option value="gobierno" {if $smarty.get.comp_type == 'gobierno'} selected="selected" {/if}>Gobierno</option>
		</select>
	...
	<div class="row" id="form_notes_container">
    		...
    		<textarea id="form_notes" name="notes" rows="4" cols="50" placeholder="Coloca aqu&iacute; cualquier nota o comentario personal sobre este documento. Lo que escribas s&oacute;lo ser&aacute; visible para los usuarios de tu cuenta.">{$smarty.post.notes}</textarea>
    			...
    			{/literal}{assign var='i' value=0}{foreach from=$companieslist item=company}{literal}{ data: '{/literal}{$company_id_[$i]}{literal}', value: '{/literal}{$company_[$i]}{literal}', ide: '{/literal}{$identification_[$i]}{literal}', street: '{/literal}{$street_[$i]}{literal}', house: '{/literal}{$house_[$i]}{literal}', city: '{/literal}{$city_[$i]}{literal}', province: '{/literal}{$province_[$i]}{literal}', postal: '{/literal}{$postal_[$i]}{literal}', country: '{/literal}{$country_[$i]}{literal}', email: '{/literal}{$email_[$i]}{literal}', web_: '{/literal}{$web_[$i]}{literal}', country_p1: '{/literal}{$country_p1_[$i]}{literal}', area_p1: '{/literal}{$area_p1_[$i]}{literal}', phone_p1: '{/literal}{$phone_p1_[$i]}{literal}', country_p2: '{/literal}{$country_p2_[$i]}{literal}', area_p2: '{/literal}{$area_p2_[$i]}{literal}', phone_p2: '{/literal}{$phone_p2_[$i]}{literal}', country_fax: '{/literal}{$country_fax_[$i]}{literal}', area_fax: '{/literal}{$area_fax_[$i]}{literal}', phone_fax: '{/literal}{$phone_fax_[$i]}{literal}', ctype: '{/literal}{$ctype[$i]}{literal}'},{/literal}{assign var='i' value=$i+1}{/foreach}{literal}{/literal}{foreach from=$contactslist item=contact}{literal}{ data: '{/literal}{$company_id_[$i]}{literal}', value: '{/literal}{$company_[$i]}{literal}', ide: '{/literal}{$identification_[$i]}{literal}', street: '{/literal}{$street_[$i]}{literal}', house: '{/literal}{$house_[$i]}{literal}', city: '{/literal}{$city_[$i]}{literal}', province: '{/literal}{$province_[$i]}{literal}', postal: '{/literal}{$postal_[$i]}{literal}', country: '{/literal}{$country_[$i]}{literal}', email: '{/literal}{$email_[$i]}{literal}', web_: '{/literal}{$web_[$i]}{literal}', country_p1: '{/literal}{$country_p1_[$i]}{literal}', area_p1: '{/literal}{$area_p1_[$i]}{literal}', phone_p1: '{/literal}{$phone_p1_[$i]}{literal}', country_p2: '{/literal}{$country_p2_[$i]}{literal}', area_p2: '{/literal}{$area_p2_[$i]}{literal}', phone_p2: '{/literal}{$phone_p2_[$i]}{literal}', country_fax: '{/literal}{$country_fax_[$i]}{literal}', area_fax: '{/literal}{$area_fax_[$i]}{literal}', phone_fax: '{/literal}{$phone_fax_[$i]}{literal}', ctype: '{/literal}{$ctype[$i]}{literal}'},{/literal}{assign var='i' value=$i+1}{/foreach}{literal}
  					...
  					// setup autocomplete function pulling from companies[] array
  						jQuery('#form_company').autocomplete({
							...
							jQuery('#form_street').val(suggestion.street); 
							jQuery('#form_house').val(suggestion.house);
							jQuery('#form_city').val(suggestion.city);
							jQuery('#form_province').val(suggestion.province); 
							jQuery('#form_postal').val(suggestion.postal);
							jQuery('#form_country').val(suggestion.country);
