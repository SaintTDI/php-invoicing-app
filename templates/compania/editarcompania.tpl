...
{/literal}</head>
<body>
<form method="post" id="comp_id" action="{geturl action='editarcompania'}?id={$fp->company->getId()}&id2={$fp->address->getId()}" enctype="multipart/form-data">
    {if $fp->hasError()}
        		<div class="error">
   ...
   <div class="row" id="form_thecompany_container">
        ...
        <input type="text" id="form_company" name="thecompany" value="{$fp->thecompany}" placeholder="Ej: Google, SL"/>
    ...
    <div class="row" id="form_identification_container">
        ...
        <input type="text" id="form_identification" name="identification" value="{$fp->identification}" placeholder="Ej: J-222-222-8"/>
        ...
        {foreach from=$fp->companyProfile key='key' item='label'}
                {if $label == 'Industry'}
     				...
     				<label for="form_industry">&Aacute;rea o Sector:</label>
        				<select id="form_industry" name="company_industry"/>
       						<option value="" {if $fp->company_industry == ''} selected="selected" {/if}>Seleccione...</option>
       						<option value="abogacia" {if $fp->company_industry == 'abogacia'} selected="selected" {/if}>Abogac&iacute;a</option>
							<option value="aeroespacial" {if $fp->company_industry == 'aeroespacial'} selected="selected" {/if}>Aeroespacial</option>
        						<option value="aerea" {if $fp->company_industry == 'aerea'} selected="selected" {/if}>Aerea</option>
        						<option value="arquitectura" {if $fp->company_industry == 'arquitectura'} selected="selected" {/if}>Arquitectura</option>
        						<option value="banca" {if $fp->company_industry == 'banca'} selected="selected" {/if}>Banca</option>
        						<option value="bienes" {if $fp->company_industry == 'bienes'} selected="selected" {/if}>Bienes de Consumo</option>
        						<option value="diseno" {if $fp->company_industry == 'diseno'} selected="selected" {/if}>Dise&ntilde;o</option>
        						<option value="distribuidor" {if $fp->company_industry == 'distribuidor'} selected="selected" {/if}>Distribuidor</option>
        						<option value="defensa" {if $fp->company_industry == 'defensa'} selected="selected" {/if}>Defensa</option>
        						<option value="energia" {if $fp->company_industry == 'energia'} selected="selected" {/if}>Energ&iacute;a</option>
        						<option value="manofactura" {if $fp->company_industry == 'manofactura'} selected="selected" {/if}>Manofactura</option>
        						<option value="mineria" {if $fp->company_industry == 'mineria'} selected="selected" {/if}>Miner&iacute;a</option>
        						<option value="retail" {if $fp->company_industry == 'retail'} selected="selected" {/if}>Retail/Tienda</option>
        						<option value="publico" {if $fp->company_industry == 'publico'} selected="selected" {/if}>Sector P&uacute;blico</option>
        						<option value="seguros" {if $fp->company_industry == 'seguros'} selected="selected" {/if}>Seguros</option>
        						<option value="seguridad" {if $fp->company_industry == 'seguridad'} selected="selected" {/if}>Seguridad</option>
        						<option value="telecomunicaciones" {if $fp->company_industry == 'telecomunicaciones'} selected="selected" {/if}>Telecomunicaciones</option>
        						<option value="tecnologia" {if $fp->company_industry == 'tecnologia'} selected="selected" {/if}>Tecnolog&iacute;as de la Informaci&oacute;n</option>
        						<option value="turismo" {if $fp->company_industry == 'turismo'} selected="selected" {/if}>Turismo</option>
        						<option value="transporte" {if $fp->company_industry == 'transporte'} selected="selected" {/if}>Transporte</option>
						</select>
                ...
                {elseif $label == 'Specialty'}
						...
						<input type="text" id="form_{$key}" maxlength="200" name="{$key}" value="{$fp->$key}" placeholder="Ej: Branding y Mercadeo"/> 
    ...
    <div class="row" id="form_street_company_container">
        ...
        <input type="text" id="form_street" name="street" value="{$fp->street}" placeholder="Calle o Avenida"/>
    ...
    <div class="row" id="form_house_company_container">
        ...
        <input type="text" id="form_house" name="house" value="{$fp->house}" placeholder="N&uacute;mero, Casa o Edificio"/>
    ...
    <div class="row" id="form_neighbourhood_company_container">
        ...
        <input type="text" id="form_neighbourhood" name="neighbourhood" value="{$fp->neighbourhood}" placeholder="Municipio o Sector"/>
    ...
    <div class="row" id="form_city_company_container">
        ...
        <input type="text" id="form_city" name="city" value="{$fp->city}" placeholder="Ciudad"/>
    ...
    <div class="row" id="form_province_company_container">
        ...
        <input type="text" id="form_province" name="province" value="{$fp->province}" placeholder="Provincia o Cant&oacute;n"/>
    ...
    <div class="row" id="form_postal_code_company_container">
        ...
        <input type="text" id="form_postal" name="postal_code" value="{$fp->postal_code}" placeholder="C&oacute;digo Postal"/>
    ...
    <input type="hidden" id="form_user_id" name="user_id" value="{if $fp->user_id}{$fp->user_id}{/if}" />
    <input type="hidden" id="form_doc_type" name="doc_type" value="{if $fp->doc_type}{$fp->doc_type}{else}{$smarty.get.doc_type}{/if}" />
    <input type="hidden" id="form_doc_id" name="doc_id" value="{if $fp->doc_id}{$fp->doc_id}{else}{$fp->company->getId()}{/if}" />
    <input type="hidden" id="form_comp_doc_type" name="comp_doc_type" value="{if $fp->comp_doc_type}{$fp->comp_doc_type}{else}{$smarty.get.doc_type}{/if}" />
    <input type="hidden" id="form_contact_id" name="contact_id" value="{if $fp->contact_id}{$fp->contact_id}{else}{$smarty.get.contact_id}{/if}" />
    ...
    *}
    <input type="hidden" id="form_email2" name="email2" value="" />
     ...
     <div class="row" id="form_{$key}_container">
     	{if $label == 'Website'}
     		...
     		<input class="social" type="text" id="form_{$key}" maxlength="200" name="{$key}" value="{$fp->$key}"  placeholder="Ej: pagina.com"/>   
    		    {include file="lib/error.tpl" error=$fp->getError($key)}
    		{elseif $label == 'Twitter'}
     		...
     		<input class="social" type="text" id="form_{$key}" maxlength="200" name="{$key}" value="{$fp->$key}"  placeholder="Ej: usuario"/>   
    		    {include file="lib/error.tpl" error=$fp->getError($key)}
      	{elseif $label == 'Address'}
     		<input type="hidden" id="form_company_address" name="company_address" value="{if $fp->address->getId()}{$fp->address->getId()}{else}{$smarty.get.id2}{/if}" />
    		    {include file="lib/error.tpl" error=$fp->getError($key)}
     	{/if}
     </div>
     {/foreach}
    ...
    <div class="row" id="form_phone_container">
        ...
        <input type="text" id="form_phone_p1" name="phone" value="{$fp->phone}" onkeypress='validate(event)' placeholder="Tel&eacute;fono"/>
    ...
    <div class="row" id="form_phone2_container">
        ...
        <input type="text" id="form_phone_p2" name="phone2" value="{$fp->phone2}" onkeypress='validate(event)' placeholder="Tel&eacute;fono"/>
    ...
    <div class="row" id="form_fax_container">
        ...
        <input type="text" id="form_phone_fax" name="fax" value="{$fp->fax}" onkeypress='validate(event)' placeholder="Tel&eacute;fono"/>
	...
	<div class="row" id="form_notes_container">
    		...
    		<textarea id="form_notes" name="notes" rows="4" cols="50" placeholder="Coloca aqu&iacute; cualquier nota o comentario personal sobre este documento. Lo que escribas s&oacute;lo ser&aacute; visible para los usuarios de tu cuenta.">{$fp->notes}</textarea>
