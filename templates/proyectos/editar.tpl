...
<body>
{else}
{include file='header.tpl' section='proyectos' subsection='editar'}
<div class="title" id="form_total_invoices">
	<label for="form_total_invoices"><h3>Editar Proyecto:</h3></label>
</div>
{/if}
<form method="post" id="projec_id" action="{geturl action='editar'}?id={$fp->project->getId()}" enctype="multipart/form-data">
    ...
    <div class="row" id="form_project_title">
        ...
        <input type="text" id="form_project_title" name="project_title" value="{$fp->project_title}" placeholder="Ej: Proyecto Vi&ntilde;edo"/>
 	...
 	<div class="row" id="form_company_container">
        <label for="form_company_ids">Cliente:</label>
        	    <input type="text" id="form_company" name="company" value="{$fp->client}" placeholder="Empresa, sociedad o persona"/>
        		<input type="hidden" id="form_company_id" name="company_id" value="{$fp->company_id}" />
        		<input type="hidden" id="form_company_address" name="company_address" value="{$fp->company_address}" />
        		<input type="hidden" id="form_data_type" name="data_type" value="{$fp->data_type}" />
        		...
        		<input type="hidden" id="form_project_id" name="project_id" value="{$fp->project->getId()}" />
        ...
        {* <a class="fancybox fancybox.iframe" href="{geturl controller='compania' action='agregarcompania'}?doc_type=ccompany&comp_doc_type=project&project_id={$fp->project->getId()}">Agregar</a> *}
  	</div>
    
    <div class="row" id="form_project_start_">
        <label for="form_project_start">Fecha de inicio:</label>
        <input type="text" id="form_project_start" name="start" value="{if $fp->start}{$fp->start}{else}{$now__}{/if}" placeholder="D&iacute;a-Mes-A&ntilde;o"/>
    ...
    <div class="row" id="form_project_ends_">
        ...
        <input type="text" id="form_project_ends" name="ends" value="{if $fp->ends}{$fp->ends}{else}{$next__}{/if}" placeholder="D&iacute;a-Mes-A&ntilde;o"/>
   ...
   {*
    <div class="row" id="form_project_team">
        ...
        <input type="text" id="form_project_team" name="team" value="{$fp->team}" placeholder="Ej: Mercadeo"/>
    ...
    *}
    <div class="row" id="form_project_budget_">
        ...
        <input type="text" id="form_project_budget" name="budget" value="{$fp->budget}" data-a-dec="," data-a-sep="." placeholder="Importe Presupuesto"/>
    ...
    <div class="row" id="form_project_expense_"> 
        ...
        <input type="text" id="form_project_expense" name="expense" value="{$fp->expense}" data-a-dec="," data-a-sep="." placeholder="Ej: 121"/>
    ...
    *}
	...
	<div class="row" id="form_project_notes">
    		...
    		<textarea id="form_project_notes" name="notes" rows="6" cols="50" placeholder="Coloca aqu&iacute; cualquier nota o comentario personal sobre este proyecto. Lo que escribas s&oacute;lo ser&aacute; visible para los usuarios de tu cuenta.">{$fp->notes}</textarea>
