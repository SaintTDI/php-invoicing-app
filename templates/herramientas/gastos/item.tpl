...
{else}	
		...
		<tr>
			...
			<td class="links"><span><a class="fancybox fancybox.iframe" href="{geturl controller='herramientas/gastos' action='editaritem'}?id={$item->getId()}&popup=true">{$item->profile->detail|ucfirst}</a></span></td>
