...
{else}	
		...
		<tr>
			...
			<td class="links"><span><a class="fancybox fancybox.iframe" href="{geturl controller='herramientas/proformas' action='editaritem'}?id={$item->getId()}&popup=true">{$item->profile->code|ucfirst}</a></span></td>
