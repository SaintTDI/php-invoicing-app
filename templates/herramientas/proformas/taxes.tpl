        ...
        {foreach from=$items2 item=item}
           {if $item->profile->iva != $iva && $item->profile->iva > 0}   		
    			<div class="form_box">  
    				...
    				{if $fp->discount}
    					{assign var='discount__' value=100 - $fp->discount}
    					{assign var='add__' value=$item->profile->iva_total * $discount__ * 0.01}
    					{assign var='total_iva_1' scope=global value=$total_iva_1 + $add__}
    				{else}
    					{assign var='total_iva_1' scope=global value=$total_iva_1 + $item->profile->iva_total}
    				{/if}
       				<label for="form_iva_">I.V.A. {$item->profile->iva} % {if $currency_ == 'Peso Argentino'}(&#36;){elseif $currency_ == 'Peso Boliviano'}(b&#36){elseif $currency_ == 'Peso Chileno'}(&#36;){elseif $currency_ == 'Peso Colombiano'}(&#36;){elseif $currency_ == 'Colon'}(&#162;){elseif $currency_ == 'Peso Dominicano'}(&#36;){elseif $currency_ == 'Dolar'}(&#36;){elseif $currency_ == 'Euro'}(&#128;){elseif $currency_ == 'Quetzal'}(Q){elseif $currency_ == 'Lempira'}(L){elseif $currency_ == 'Peso Mexicano'}(&#36;){elseif $currency_ == 'Cordoba'}(C&#36;){elseif $currency_ == 'Balboa'}(B/.){elseif $currency_ == 'Guarani'}(&#8370;){elseif $currency_ == 'Nuevo Sol'}(S/.){elseif $currency_ == 'Libra'}(&#163;){elseif $currency_ == 'Peso Uruguayo'}(&#36;){elseif $currency_ == 'Bolivar'}(Bs.){else}(&#128;){/if}:</label>

        				<input type="text" id="form_iva_{$tot_item}" name="iva_{$tot_item}" value="{$iva_total}" data-a-dec="," data-a-sep="." data-v-min="-999999999.99"  />
        				<input type="hidden" id="form_iva_p_{$tot_item}" name="iva_p_{$tot_item}" value="{if $item->profile->iva}{$item->profile->iva|number_format:2:',':'.'}{else}0{/if}"/>
        ...
        {foreach from=$items3 item=item}      		
			{if $item->profile->iva2 != $iva2 && $item->profile->iva2 > 0}
    			  <div class="form_box">
    				...
    				{if $fp->discount}
    					{assign var='discount2__' value=100 - $fp->discount}
    					{assign var='add2__' value=$item->profile->iva2_total * $discount2__ * 0.01}
    					{assign var='total_iva_2' scope=global value=$total_iva_2 + $add2__}
    				{else}
    					{assign var='total_iva_2' scope=global value=$total_iva_2 + $item->profile->iva2_total}
    				{/if}
       				<label for="form_iva2_">Otros Imp. {$item->profile->iva2} % {if $currency_ == 'Peso Argentino'}(&#36;){elseif $currency_ == 'Peso Boliviano'}(b&#36){elseif $currency_ == 'Peso Chileno'}(&#36;){elseif $currency_ == 'Peso Colombiano'}(&#36;){elseif $currency_ == 'Colon'}(&#162;){elseif $currency_ == 'Peso Dominicano'}(&#36;){elseif $currency_ == 'Dolar'}(&#36;){elseif $currency_ == 'Euro'}(&#128;){elseif $currency_ == 'Quetzal'}(Q){elseif $currency_ == 'Lempira'}(L){elseif $currency_ == 'Peso Mexicano'}(&#36;){elseif $currency_ == 'Cordoba'}(C&#36;){elseif $currency_ == 'Balboa'}(B/.){elseif $currency_ == 'Guarani'}(&#8370;){elseif $currency_ == 'Nuevo Sol'}(S/.){elseif $currency_ == 'Libra'}(&#163;){elseif $currency_ == 'Peso Uruguayo'}(&#36;){elseif $currency_ == 'Bolivar'}(Bs.){else}(&#128;){/if}:</label>
        				...
        				<input type="hidden" id="form_iva2_p_{$tot_item2}" name="iva2_p_{$tot_item2}" value="{if $item->profile->iva2}{$item->profile->iva2|number_format:2:',':'.'}{else}0{/if}"/>
