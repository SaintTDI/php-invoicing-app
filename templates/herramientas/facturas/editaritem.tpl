...
<body id="popup">
<form method="post" id="edititem_id" action="{geturl action='editaritem'}?id={$fp->item->getId()}">
	...
	<div class="row" id="form_item_detail_container">
    		...
    		<textarea id="form_item_detail" name="detail" rows="10" cols="50" placeholder="Ej: Servicio de Consultor&iacute;a y Asesor&iacute;a">{$fp->detail}</textarea>
    ...
    <div class="row" id="form_unit_price_container"> 
        <label for="form_unit_price_">Precio Unitario sin Impuestos <span id="outputcontent3">{if $fp->currency == 'Peso Argentino'}&#36;{elseif $fp->currency == 'Peso Boliviano'}b&#36{elseif $fp->currency == 'Peso Chileno'}&#36;{elseif $fp->currency == 'Peso Colombiano'}&#36;{elseif $fp->currency == 'Colon'}&#162;{elseif $fp->currency == 'Peso Dominicano'}&#36;{elseif $fp->currency == 'Dolar'}&#36;{elseif $fp->currency == 'Euro'}&#128;{elseif $fp->currency == 'Quetzal'}Q{elseif $fp->currency == 'Lempira'}L{elseif $fp->currency == 'Peso Mexicano'}&#36;{elseif $fp->currency == 'Cordoba'}C&#36;{elseif $fp->currency == 'Balboa'}B/.{elseif $fp->currency == 'Guarani'}&#8370;{elseif $fp->currency == 'Nuevo Sol'}S/.{elseif $fp->currency == 'Libra'}&#163;{elseif $fp->currency == 'Peso Uruguayo'}&#36;{elseif $fp->currency == 'Bolivar'}Bs.{else}&#128;{/if} <strong>&#x28;&#x2A;&#x29;</strong>:</span></label>
        <input type="text" id="form_unit_price" name="unit_price" value="{$fp->unit_price}" data-a-dec="," data-a-sep="." data-v-min="-999999999.99" placeholder="Precio Unitario sin Impuestos" />
    ...
    <div class="row" id="form_iva_container"> 
        ...
        <input type="text" id="form_iva" name="iva" value="{$fp->iva}" data-a-dec="," data-a-sep="." data-v-min="-999999999.99" placeholder="Escribe 21 para el 21&#x25; de impuesto" />
    ...
    <div class="row" id="form_iva2_container"> 
        ...
        <input type="text" id="form_iva2" name="iva2" value="{$fp->iva2}" data-a-dec="," data-a-sep="." data-v-min="-999999999.99" placeholder="Escribe 2 para el 2&#x25; de impuesto"/>
