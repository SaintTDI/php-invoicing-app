...
<body id="popup">
<form method="post" id="agregaritem_id" action="{geturl action='agregaritem'}?id={$fp->item->getId()}">
	...
	<div class="row" id="form_item_detail_container">
    		...
    		<textarea id="form_item_detail" name="detail" rows="10" cols="50" placeholder="Ej: Servicio de Consultor&iacute;a y Asesor&iacute;a">{$smarty.post.detail}</textarea>
    ...
    <div class="row" id="form_quantity_container"> 
        ...
        <input type="text" id="form_quantity" name="quantity" data-a-dec="," data-a-sep="." data-v-min="-999999999.99" placeholder="Cantidad" value="{$smarty.post.quantity}" />
