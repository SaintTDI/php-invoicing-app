...
<body id="popup">
<form id="comp_id" method="post" action="{geturl action='editarcompania'}?id={$fp->company->getId()}&document_id={$fp->document_id}">
    ...
    <div class="row" id="form_house_company_container">
        ...
        <input type="text" id="street_number" name="house" value="{$fp->house}" placeholder="N&uacute;mero, Casa o Edificio"/>
