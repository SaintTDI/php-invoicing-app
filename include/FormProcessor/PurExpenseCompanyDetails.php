<?php
    class FormProcessor_PurExpenseCompanyDetails extends FormProcessor
    {
        protected $db = null;
        public $user_id = null;
        ...
        public function __construct($db, $user_id, $company_id = 0, $company_id2, $doc_id)
        {
            ...
            $this->company = new DatabaseObject_ExpenseCompany($db);
			$this->company->loadForUser($this->user->getId(), $company_id);

            $this->company2 = new DatabaseObject_PurchaseCompany($db);
