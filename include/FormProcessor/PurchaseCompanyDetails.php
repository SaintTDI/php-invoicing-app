<?php
    class FormProcessor_PurchaseCompanyDetails extends FormProcessor
    {
        protected $db = null;
        public $user = null;
		public $company = null;
        ...
        public function __construct($db, $user_id, $company_id = 0, $company_id2 = 0, $address_id = 0)
        {
            ...
            $this->company = new DatabaseObject_PurchaseCompany($db);
        ...
        public function process(Zend_Controller_Request_Abstract $request)
        {
			...
			if (!$this->company_id) {
				if (!$this->ctype) {
					...
					$this->company2->comp_doc_type = 'purchase';
