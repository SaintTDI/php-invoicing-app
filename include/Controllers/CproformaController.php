<?php
    class CproformaController extends CustomControllerAction
    {
    		protected $user = null;
        ...
        public function editarcompaniaAction()
        {
            ...
            $company = new DatabaseObject_ProformaCompany($this->db);
			...
			$fp = new FormProcessor_ProformaCompanyDetails($this->db,
