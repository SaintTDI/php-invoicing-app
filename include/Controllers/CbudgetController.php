<?php
    class CbudgetController extends CustomControllerAction
    {
    		protected $user = null;
        ...
        public function editarcompaniaAction()
        {
            ...
            $company = new DatabaseObject_BudgetCompany($this->db);
			...
			$fp = new FormProcessor_BudgetCompanyDetails($this->db,
