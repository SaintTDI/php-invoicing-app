<?php
    class CpurchaseController extends CustomControllerAction
    {
    		protected $user = null;
        ...
        public function editarcompaniaAction()
        {
            ...
            $company = new DatabaseObject_PurchaseCompany($this->db);
			...
			$fp = new FormProcessor_PurchaseCompanyDetails($this->db,
