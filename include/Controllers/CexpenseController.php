<?php
    class CexpenseController extends CustomControllerAction
    {
    		protected $user = null;
        ...
        public function editarcompaniaAction()
        {
            ...
            $company = new DatabaseObject_ExpenseCompany($this->db);
			...
			$fp = new FormProcessor_ExpenseCompanyDetails($this->db,
