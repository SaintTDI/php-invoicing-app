...
require_once $droute . '/calendar/event_subject.php';
require_once $droute . '/calendar/event_observer.php';
require_once $droute . '/calendar/calendar_event.php';
...
class Calendar extends Event_Subject {
	...
	public function year($length = TRUE)
	{
		$date = mktime(0, 0, 0, $this->month, 1, $this->year);
		$year_  = date('Y', $date);
