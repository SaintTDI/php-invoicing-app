<?php /* Smarty version Smarty-3.0.8, created on 2015-02-15 23:38:13
         compiled from "/var/www/app/templates/./cuenta/registro2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:44827730554e11fd56a2552-05639676%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dfd9edd4cde0dc547af326a5c86aaaaf8ba19cb8' => 
    array (
      0 => '/var/www/app/templates/./cuenta/registro2.tpl',
      1 => 1423691237,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '44827730554e11fd56a2552-05639676',
  'function' => 
  array (
  ),
...
$_template->assign('section','cuenta');$_template->assign('subsection','registro2'); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
...
<div id="registro">
	...
	<form id="registration_id" name="registration" method="post" action="<?php echo smarty_function_geturl(array('action'=>'registro2'),$_smarty_tpl);?>
">
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('password')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	    ...
	    <input type="hidden" name="plan" value="trial_plan1">
