<?php /* Smarty version Smarty-3.0.8, created on 2015-03-18 16:39:14
         compiled from "/var/www/app/templates/./herramientas/gastos/editaritem.tpl" */ ?>
<?php /*%%SmartyHeaderCode:204899519755099c22209544-23062677%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65968b1a658aeba2afe75e5441f8cfcd1b824fad' => 
    array (
      0 => '/var/www/app/templates/./herramientas/gastos/editaritem.tpl',
      1 => 1423691289,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '204899519755099c22209544-23062677',
  'function' => 
  array (
  ),
...
<body id="popup">
<form method="post" id="expens_id" action="<?php echo smarty_function_geturl(array('action'=>'editaritem'),$_smarty_tpl);?>
...
">
    ...
    <div class="row" id="form_code_item_container_">
        ...
        <input type="text" id="form_code_item" name="code" value="<?php echo $_smarty_tpl->getVariable('fp')->value->code;?>
" placeholder="Ej: 123"/>
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('code')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>   
	...
	<div class="row" id="form_item_detail_container">
    		...
    		<textarea id="form_item_detail" name="detail" rows="10" cols="50" placeholder="Ej: Servicio de Internet"><?php echo $_smarty_tpl->getVariable('fp')->value->detail;?>
</textarea>
    		<?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
...
'},<?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable($_smarty_tpl->getVariable('i')->value+1, null, null);?><?php }} ?>
    ...
    <div class="row" id="form_product_unit_container">
        ...
        <select id="form_product_unit" name="product_unit"/>
       		<option value="" <?php if ($_smarty_tpl->getVariable('fp')->value->product_unit==''){?> selected="selected" <?php }?>>Seleccione...</option>
			<option value="unidad" <?php if ($_smarty_tpl->getVariable('fp')->value->product_unit=='unidad'){?> selected="selected" <?php }?>>Unidad(es) (1)</option>
			<option value="decena" <?php if ($_smarty_tpl->getVariable('fp')->value->product_unit=='decena'){?> selected="selected" <?php }?>>Decena(s) (10)</option>
        		<option value="docena" <?php if ($_smarty_tpl->getVariable('fp')->value->product_unit=='docuena'){?> selected="selected" <?php }?>>Docena(s) (12)</option>
        		<option value="centena" <?php if ($_smarty_tpl->getVariable('fp')->value->product_unit=='centena'){?> selected="selected" <?php }?>>Centena(s) (100)</option>
        		<option value="metro" <?php if ($_smarty_tpl->getVariable('fp')->value->product_unit=='metro'){?> selected="selected" <?php }?>>Metro(s) (m)</option>
        		<option value="litro" <?php if ($_smarty_tpl->getVariable('fp')->value->product_unit=='litro'){?> selected="selected" <?php }?>>Litro(s) (l)</option>
        		<option value="kilo" <?php if ($_smarty_tpl->getVariable('fp')->value->product_unit=='kilo'){?> selected="selected" <?php }?>>Kilo(s) (kg)</option>
		</select>
        <?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('product_unit')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
   ...
   <input type="hidden" id="form_currency" name="currency" value="<?php echo $_smarty_tpl->getVariable('fp')->value->currency;?>
">
    
    	
    <div class="row" id="form_quantity_container"> 
        <label for="form_quantity_">Cantidad <strong>&#x28;&#x2A;&#x29;</strong>:</label>
        <input type="text" id="form_quantity" name="quantity" value="<?php echo $_smarty_tpl->getVariable('fp')->value->quantity;?>
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('quantity')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <div class="row" id="form_unit_cost_container"> 
        <label for="form_unit_cost_">Costo Unitario sin Impuestos <span id="outputcontent3"><?php if ($_smarty_tpl->getVariable('fp')->value->currency=='Peso Argentino'){?>&#36;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Peso Boliviano'){?>b&#36<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Peso Chileno'){?>&#36;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Peso Colombiano'){?>&#36;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Colon'){?>&#162;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Peso Dominicano'){?>&#36;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Dolar'){?>&#36;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Euro'){?>&#128;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Quetzal'){?>Q<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Lempira'){?>L<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Peso Mexicano'){?>&#36;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Cordoba'){?>C&#36;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Balboa'){?>B/.<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Guarani'){?>&#8370;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Nuevo Sol'){?>S/.<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Libra'){?>&#163;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Peso Uruguayo'){?>&#36;<?php }elseif($_smarty_tpl->getVariable('fp')->value->currency=='Bolivar'){?>Bs.<?php }else{ ?>&#128;<?php }?> <strong>&#x28;&#x2A;&#x29;</strong></span></label>
        <input type="text" id="form_unit_cost" name="unit_cost" value="<?php echo $_smarty_tpl->getVariable('fp')->value->unit_cost;?>
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('unit_cost')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <div class="row" id="form_iva_container"> 
        ...
        <input type="text" id="form_iva" name="iva" value="<?php echo $_smarty_tpl->getVariable('fp')->value->iva_p;?>
" data-a-dec="," data-a-sep="." data-v-min="-999999999.99" placeholder="Escribe 21 para el 21&#x25; de impuesto"/>
        <?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('iva_p')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <div class="row" id="form_iva2_name_container"> 
        ...
        <input type="text" id="form_iva2_name" name="iva2_name" value="<?php echo $_smarty_tpl->getVariable('fp')->value->iva_p2_name;?>
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('iva_p2_name')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <div class="row" id="form_iva2_container"> 
        ...
        <input type="text" id="form_iva2" name="iva2" value="<?php echo $_smarty_tpl->getVariable('fp')->value->iva_p2;?>
" data-a-dec="," data-a-sep="." data-v-min="-999999999.99" placeholder="Escribe 2 para el 2&#x25; de impuesto"/>
        <?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('iva2')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	...
	<input type="hidden" id="form_document_type" name="document_type" value="<?php echo $_smarty_tpl->getVariable('fp')->value->document_type;?>
">
    <input type="hidden" id="form_document_id" name="document_id" value="<?php echo $_smarty_tpl->getVariable('fp')->value->document_id;?>
">
    <input type="hidden" id="form_product_id" name="product_id" value="<?php echo $_smarty_tpl->getVariable('fp')->value->product_id;?>
">
