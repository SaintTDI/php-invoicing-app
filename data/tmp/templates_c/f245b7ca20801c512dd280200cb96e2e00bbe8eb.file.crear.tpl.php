<?php /* Smarty version Smarty-3.0.8, created on 2015-02-23 01:50:49
         compiled from "/var/www/app/templates/./herramientas/gastos/crear.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5041225254ea7969122014-21466025%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f245b7ca20801c512dd280200cb96e2e00bbe8eb' => 
    array (
      0 => '/var/www/app/templates/./herramientas/gastos/crear.tpl',
      1 => 1423691287,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5041225254ea7969122014-21466025',
  'function' => 
  array (
  ),
...
<form method="post" id="expense_id" enctype="multipart/form-data" action="<?php echo smarty_function_geturl(array('action'=>'crear'),$_smarty_tpl);?>
...
">
   ...
   <?php }?>
    <input type="hidden" class="stored" id="form_consecutive" name="expense_consecutive" value="<?php echo $_POST['expense_consecutive'];?>
" />
	...
	<div class="form_box">
		<div class="form_left">
		    <div class="row" id="form_expense_number_">
		        ...
		        <input type="text" class="stored" id="form_expense_number" name="expense_number" value="<?php if ($_POST['expense_number']){?><?php echo $_POST['expense_number'];?>
<?php }else{ ?><?php echo $_smarty_tpl->getVariable('expensecount')->value+1;?>
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('expense_number')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
		    ...
		    <div class="row" id="form_invc_valid_">
		        ...
		        <select class="frecuency stored" id="form_expense_vali" name="expense_valid">
					<option value="0.00" <?php if ($_smarty_tpl->getVariable('expense')->value->profile->expense_valid=='0.00'){?>selected="selected" <?php }?>>Contado</option>
					<option value="7" <?php if ($_POST['expense_valid']=='7'){?>selected="selected" <?php }?>>7 d&iacute;as</option>
					<option value="15" <?php if ($_POST['expense_valid']=='15'){?>selected="selected" <?php }?>>15 d&iacute;as</option>
					<option value="21" <?php if ($_POST['expense_valid']=='21'){?>selected="selected" <?php }?>>21 d&iacute;as</option>
					<option value="30" <?php if ($_POST['expense_valid']=='30'){?>selected="selected" <?php }?>>30 d&iacute;as</option>
					<option value="45" <?php if ($_POST['expense_valid']=='45'){?>selected="selected" <?php }?>>45 d&iacute;as</option>
					<option value="60" <?php if ($_POST['expense_valid']=='60'){?>selected="selected" <?php }?>>60 d&iacute;as</option>
					<option value="75" <?php if ($_POST['expense_valid']=='75'){?>selected="selected" <?php }?>>75 d&iacute;as</option>
					<option value="90" <?php if ($_POST['expense_valid']=='90'){?>selected="selected" <?php }?>>90 d&iacute;as</option>
					<option value="120" <?php if ($_POST['expense_valid']=='120'){?>selected="selected" <?php }?>>120 d&iacute;as</option>
					<option value="180" <?php if ($_POST['expense_valid']=='180'){?>selected="selected" <?php }?>>180 d&iacute;as</option>
				</select>
		    </div>
		</div>
		<div class="form_right">
		    <div class="row" id="form_expense_date_">
		        ...
		        <input type="text" class="stored" id="form_expense_date" name="expense_date" value="<?php if ($_POST['expense_date']){?><?php echo $_POST['expense_date'];?>
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('expense_date')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
		    ...
		    <div class="row" id="form_expense_type">
		        ...
		        <select class="frecuency stored" id="form_expense_type" name="expense_type">
					<option value="Alquileres" <?php if ($_POST['expense_type']=='Alquileres'){?>selected="selected" <?php }?>>Alquileres</option>
					<option value="Reparaciones" <?php if ($_POST['expense_type']=='Reparaciones'){?>selected="selected" <?php }?>>Reparaciones</option>
					<option value="Servicios Prof. Independientes" <?php if ($_POST['expense_type']=='Servicios Prof. Independientes'){?>selected="selected" <?php }?>>Servicios Prof. Independientes</option>
					<option value="Viajes y Transportes" <?php if ($_POST['expense_type']=='Viajes y Transportes'){?>selected="selected" <?php }?>>Viajes y Transportes</option>
					<option value="Primas de Seguros" <?php if ($_POST['expense_type']=='Primas de Seguros'){?>selected="selected" <?php }?>>Primas de Seguros</option>
					<option value="Marketing y Publicidad" <?php if ($_POST['expense_type']=='Marketing y Publicidad'){?>selected="selected" <?php }?>>Marketing y Publicidad</option>	
					<option value="Manutención" <?php if ($_POST['expense_type']=='Manutención'){?>selected="selected" <?php }?>>Manutenci&oacute;n</option>
					<option value="Oficina" <?php if ($_POST['expense_type']=='Oficina'){?>selected="selected" <?php }?>>Oficina</option>
					<option value="Suministros" <?php if ($_POST['expense_type']=='Suministros'){?>selected="selected" <?php }?>>Suministros</option>
					<option value="Mercaderías" <?php if ($_POST['expense_type']=='Mercaderías'){?>selected="selected" <?php }?>>Mercader&iacute;as</option>	
					<option value="Empleados" <?php if ($_POST['expense_type']=='Empleados'){?>selected="selected" <?php }?>>Empleados</option>
					<option value="Gastos Financieros" <?php if ($_POST['expense_type']=='Gastos Financieros'){?>selected="selected" <?php }?>>Gastos Financieros</option>
					<option value="Tributos" <?php if ($_POST['expense_type']=='Tributos'){?>selected="selected" <?php }?>>Tributos</option>
					<option value="Gastos Varios" <?php if ($_POST['expense_type']=='Gastos Varios'||$_POST['expense_type']==''){?>selected="selected" <?php }?>>Gastos Varios</option>
				</select>
		        <?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
	...
	<div class="form_box">
		<div class="form_left">
		    <div class="row" id="form_invoice_number_">
		        ...
		        <input type="text" class="stored" id="form_invoice_number" name="invoice_number" value="<?php echo $_POST['invoice_number'];?>
" placeholder="Ej: A201"/>
		        <?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
...
"/>
			             		<?php $_smarty_tpl->tpl_vars["url"] = new Smarty_variable($_smarty_tpl->getVariable('expense')->value->profile->{$_smarty_tpl->getVariable('key')->value}, null, null);?>
		...
		<div class="form_left">
		 	<div class="row" id="form_contact_container">
		        <label for="form_contact_ids">Contacto:</label>
		        	    <input type="text" class="stored" id="form_contact" name="expense_contact" value="<?php echo $_POST['expense_contact'];?>
		...
		<div class="form_right">
		 	<div class="row" id="form_project_container">
		        <label for="form_project_ids">Proyecto:</label>
		        	    <input type="text" class="stored" id="form_project" name="expense_project" value="<?php echo $_POST['expense_project'];?>
...
?document_type=expense&document_id=<?php echo $_smarty_tpl->getVariable('inv_id')->value;?>
...
$_template->assign('document_type','expense');$_template->assign('document_id',$_smarty_tpl->getVariable('inv_id')->value); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <div class="form_box">
	    <div class="row" id="form_retention_">
	        <label for="form_retention_">Retenci&oacute;n (&#37;):</label>
	         <?php $_smarty_tpl->tpl_vars['current_retention'] = new Smarty_variable($_smarty_tpl->getVariable('default_retention_provider')->value, null, null);?><?php $_smarty_tpl->tpl_vars['current_ret'] = new Smarty_variable($_smarty_tpl->getVariable('current_retention')->value*0.01*$_smarty_tpl->getVariable('current_base')->value, null, null);?>
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('total')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
	...
	<div class="row" id="form_expense_notes">
    		...
    		<textarea id="form_expense_notes" class="big_textarea stored" name="notes" rows="6" cols="50" placeholder="Coloca aqu&iacute; cualquier nota o comentario personal sobre este documento. Lo que escribas s&oacute;lo ser&aacute; visible para los usuarios de tu cuenta."><?php echo $_POST['notes'];?>
</textarea>
    		<?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
