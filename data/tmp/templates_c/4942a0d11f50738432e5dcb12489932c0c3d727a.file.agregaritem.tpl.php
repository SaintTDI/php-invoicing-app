<?php /* Smarty version Smarty-3.0.8, created on 2015-03-18 17:29:15
         compiled from "/var/www/app/templates/./herramientas/facturas/agregaritem.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20878406845509a7db61fbf4-66913280%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4942a0d11f50738432e5dcb12489932c0c3d727a' => 
    array (
      0 => '/var/www/app/templates/./herramientas/facturas/agregaritem.tpl',
      1 => 1423691275,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20878406845509a7db61fbf4-66913280',
  'function' => 
  array (
  ),
...
<body id="popup">
<form method="post" id="agregaritem_id" action="<?php echo smarty_function_geturl(array('action'=>'agregaritem'),$_smarty_tpl);?>
...
'},<?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable($_smarty_tpl->getVariable('i')->value+1, null, null);?><?php }} ?>
	...
	<div class="row" id="form_item_detail_container">
    		...
    		<textarea id="form_item_detail" name="detail" rows="10" cols="50" placeholder="Ej: Servicio de Consultor&iacute;a y Asesor&iacute;a"><?php echo $_POST['detail'];?>
</textarea>
    		<?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('detail')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <div class="row" id="form_quantity_container"> 
        ...
        <input type="text" id="form_quantity" name="quantity" data-a-dec="," data-a-sep="." data-v-min="-999999999.99" placeholder="Cantidad" value="<?php echo $_POST['quantity'];?>
" />
        <?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
