<?php /* Smarty version Smarty-3.0.8, created on 2015-02-15 22:49:43
         compiled from "/var/www/app/templates/./herramientas/facturas/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22612532654e114770639c5-42075886%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0e05c1736c2efcffca6cd6aec928b87560954d1e' => 
    array (
      0 => '/var/www/app/templates/./herramientas/facturas/index.tpl',
      1 => 1423691281,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22612532654e114770639c5-42075886',
  'function' => 
  array (
  ),
...
<div class="boxes3">
	...
	<div class="boton_top">
	        <label for="bt_">
	       	 	<a class="submit6" <?php if ($_smarty_tpl->getVariable('identity')->value->trial_expired){?><?php }else{ ?>href="<?php echo smarty_function_geturl(array('controller'=>'herramientas/facturas','action'=>'crear'),$_smarty_tpl);?>
"<?php }?> onclick="clearLocalStorage();">Nueva Factura</a>
			</label>
	</div>
</div>
		<?php if (count($_smarty_tpl->getVariable('invoices')->value)==0){?>
...
<div class="title" id="form_total_invoices">
	<label for="form_total_invoices"><h3>Facturaci&oacute;n <?php echo $_smarty_tpl->getVariable('year__')->value;?>
</h3></label>
</div>
...
<?php if (count($_smarty_tpl->getVariable('clients')->value)>0){?>
...
<?php }else{ ?>
		<div class="title" id="form_total_invoices">
    	   ...
    	   <form method="post" id="expend_id2" action="<?php echo smarty_function_geturl(array('action'=>'index'),$_smarty_tpl);?>
">
    	    <table class="table_p">
    	  	 <tr>
         ...
         <?php $_smarty_tpl->tpl_vars['m'] = new Smarty_variable(0, null, null);?><?php $_smarty_tpl->tpl_vars['iva_2'] = new Smarty_variable(0, null, null);?><?php $_smarty_tpl->tpl_vars['iva2_2'] = new Smarty_variable(0, null, null);?><?php $_smarty_tpl->tpl_vars['ii'] = new Smarty_variable(0, null, null);?><?php  $_smarty_tpl->tpl_vars['invoice'] = new Smarty_Variable;
...
?>
         ...
         <?php if ($_smarty_tpl->getVariable('id__')->value==$_smarty_tpl->getVariable('invoices_up')->value[$_smarty_tpl->getVariable('m')->value]){?>
			<tr>
				<td class="links"><span><a href="<?php echo smarty_function_geturl(array('controller'=>'herramientas/facturas','action'=>'fichafactura'),$_smarty_tpl);?>
?id=<?php echo $_smarty_tpl->getVariable('invoice')->value->getId();?>
" onclick="clearLocalStorage();"><?php if ($_smarty_tpl->getVariable('invoice')->value->profile->start_letter){?><?php echo $_smarty_tpl->getVariable('invoice')->value->profile->start_letter;?>
...
<?php echo $_smarty_tpl->getVariable('invoice')->value->invoice_number;?>
				...
				<?php if ($_smarty_tpl->getVariable('invoice')->value->profile->amountpay){?><td class="links <?php echo $_smarty_tpl->getVariable('class_ii')->value[$_smarty_tpl->getVariable('ii')->value];?>
"><span><a <?php if ($_smarty_tpl->getVariable('identity')->value->trial_expired){?><?php }else{ ?>class="fancybox fancybox.iframe" href="<?php echo smarty_function_geturl(array('controller'=>'herramientas/facturas','action'=>'editarpago'),$_smarty_tpl);?>
?id=<?php echo $_smarty_tpl->getVariable('invoice')->value->getId();?>
...
"><span><a <?php if ($_smarty_tpl->getVariable('identity')->value->trial_expired){?><?php }else{ ?>class="fancybox fancybox.iframe" href="<?php echo smarty_function_geturl(array('controller'=>'herramientas/facturas','action'=>'pagofactura'),$_smarty_tpl);?>
?id=<?php echo $_smarty_tpl->getVariable('invoice')->value->getId();?>
"<?php }?> onclick="clearLocalStorage();"><?php echo ucfirst($_smarty_tpl->getVariable('status_ii')->value[$_smarty_tpl->getVariable('ii')->value]);?>
</a></span></td><?php }?>
			</tr>
...
<?php if (count($_smarty_tpl->getVariable('invoices')->value)>0){?>
		<div class="title" id="form_total_invoices">
    	   ...
    	   <form method="post" id="expend_id" action="<?php echo smarty_function_geturl(array('action'=>'index'),$_smarty_tpl);?>
">
    	    <table class="table_p">
    	  	 <tr>
			<td class="table_p_top">Factura No</td>
         ...
         <?php $_smarty_tpl->tpl_vars['iva_'] = new Smarty_variable(0, null, null);?><?php $_smarty_tpl->tpl_vars['iva2_'] = new Smarty_variable(0, null, null);?><?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable(0, null, null);?><?php  $_smarty_tpl->tpl_vars['invoice'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('invoices')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['invoice']->key => $_smarty_tpl->tpl_vars['invoice']->value){
?>
...
<?php echo $_smarty_tpl->getVariable('invoice')->value->invoice_number;?>
				...
				<?php if ($_smarty_tpl->getVariable('invoice')->value->profile->amountpay){?><?php if ($_smarty_tpl->getVariable('invoice')->value->profile->published){?><td class="links <?php echo $_smarty_tpl->getVariable('class_i')->value[$_smarty_tpl->getVariable('i')->value];?>
"><span><a <?php if ($_smarty_tpl->getVariable('identity')->value->trial_expired){?><?php }else{ ?>class="fancybox fancybox.iframe" href="<?php echo smarty_function_geturl(array('controller'=>'herramientas/facturas','action'=>'editarpago'),$_smarty_tpl);?>
?id=<?php echo $_smarty_tpl->getVariable('invoice')->value->getId();?>
...
</td><?php }?><?php }else{ ?><?php if ($_smarty_tpl->getVariable('invoice')->value->profile->published){?><td class="links <?php echo $_smarty_tpl->getVariable('class_i')->value[$_smarty_tpl->getVariable('i')->value];?>
"><span><a <?php if ($_smarty_tpl->getVariable('identity')->value->trial_expired){?><?php }else{ ?>class="fancybox fancybox.iframe" href="<?php echo smarty_function_geturl(array('controller'=>'herramientas/facturas','action'=>'pagofactura'),$_smarty_tpl);?>
?id=<?php echo $_smarty_tpl->getVariable('invoice')->value->getId();?>
"<?php }?> onclick="clearLocalStorage();"><?php echo ucfirst($_smarty_tpl->getVariable('status_i')->value[$_smarty_tpl->getVariable('i')->value]);?>
</a></span></td><?php }else{ ?><td class="links <?php echo $_smarty_tpl->getVariable('class_i')->value[$_smarty_tpl->getVariable('i')->value];?>
