<?php /* Smarty version Smarty-3.0.8, created on 2015-03-18 17:31:20
         compiled from "/var/www/app/templates/./herramientas/facturas/editaritem.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2329937795509a8583eb062-04672650%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '613f061b76820c41bb956289bb739095306794ea' => 
    array (
      0 => '/var/www/app/templates/./herramientas/facturas/editaritem.tpl',
      1 => 1423691278,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2329937795509a8583eb062-04672650',
  'function' => 
  array (
  ),
...
<body id="popup">
<form method="post" id="edititem_id" action="<?php echo smarty_function_geturl(array('action'=>'editaritem'),$_smarty_tpl);?>
...
'},<?php $_smarty_tpl->tpl_vars['i'] = new Smarty_variable($_smarty_tpl->getVariable('i')->value+1, null, null);?><?php }} ?>
	...
	<div class="row" id="form_item_detail_container">
    		...
    		<textarea id="form_item_detail" name="detail" rows="10" cols="50" placeholder="Ej: Servicio de Consultor&iacute;a y Asesor&iacute;a"><?php echo $_smarty_tpl->getVariable('fp')->value->detail;?>
</textarea>
    		<?php $_template = new Smarty_Internal_Template("lib/error.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('unit_price')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <div class="row" id="form_iva_container"> 
        ...
        <input type="text" id="form_iva" name="iva" value="<?php echo $_smarty_tpl->getVariable('fp')->value->iva;?>
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('iva')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <div class="row" id="form_iva2_name_container"> 
        ...
        <input type="text" id="form_iva2_name" name="iva2_name" value="<?php echo $_smarty_tpl->getVariable('fp')->value->iva2_name;?>
...
$_template->assign('error',$_smarty_tpl->getVariable('fp')->value->getError('iva2_name')); echo $_template->getRenderedTemplate(); $_template->rendered_content = null;?><?php unset($_template);?>
    ...
    <div class="row" id="form_iva2_container"> 
        ...
        <input type="text" id="form_iva2" name="iva2" value="<?php echo $_smarty_tpl->getVariable('fp')->value->iva2;?>
