<?php /* Smarty version Smarty-3.0.8, created on 2015-02-23 01:50:49
         compiled from "/var/www/app/templates/./herramientas/gastos/taxes.tpl" */ ?>
<?php /*%%SmartyHeaderCode:157058101854ea7969624113-83810205%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '86b616b36e93d4e6f5363415e217361ccd8669cf' => 
    array (
      0 => '/var/www/app/templates/./herramientas/gastos/taxes.tpl',
      1 => 1423691296,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '157058101854ea7969624113-83810205',
  'function' => 
  array (
  ),
...
?>
           <?php if ($_smarty_tpl->getVariable('item')->value->profile->iva_p!=$_smarty_tpl->getVariable('iva')->value&&$_smarty_tpl->getVariable('item')->value->profile->iva_p>0){?>   		
    			<div class="form_box"> 
    				...
    				<?php if ($_smarty_tpl->getVariable('fp')->value->discount){?>
    					<?php $_smarty_tpl->tpl_vars['discount__'] = new Smarty_variable(100-$_smarty_tpl->getVariable('fp')->value->discount, null, null);?>
    					<?php $_smarty_tpl->tpl_vars['add__'] = new Smarty_variable($_smarty_tpl->getVariable('item')->value->profile->iva_p_total*$_smarty_tpl->getVariable('discount__')->value*0.01, null, null);?>
    				...
    				<?php }else{ ?>
    					<?php $_smarty_tpl->tpl_vars['total_iva_1'] = new Smarty_variable($_smarty_tpl->getVariable('total_iva_1')->value+$_smarty_tpl->getVariable('item')->value->profile->iva_p_total, null, 3);?>
    				<?php }?>
       				<label for="form_iva_">I.V.A. <?php echo $_smarty_tpl->getVariable('item')->value->profile->iva_p;?>
...
" value="<?php if ($_smarty_tpl->getVariable('item')->value->profile->iva_p){?><?php echo number_format($_smarty_tpl->getVariable('item')->value->profile->iva_p,2,',','.');?>
<?php }else{ ?>0<?php }?>"/>
...
?>      		
			<?php if ($_smarty_tpl->getVariable('item')->value->profile->iva_p2!=$_smarty_tpl->getVariable('iva2')->value&&$_smarty_tpl->getVariable('item')->value->profile->iva_p2>0){?>
    			<div class="form_box"> 
    				...
    				<?php if ($_smarty_tpl->getVariable('fp')->value->discount){?>
    					<?php $_smarty_tpl->tpl_vars['discount2__'] = new Smarty_variable(100-$_smarty_tpl->getVariable('fp')->value->discount, null, null);?>
    					<?php $_smarty_tpl->tpl_vars['add2__'] = new Smarty_variable($_smarty_tpl->getVariable('item')->value->profile->iva_p2_total*$_smarty_tpl->getVariable('discount2__')->value*0.01, null, null);?>
    				...
    				<?php }else{ ?>
    					<?php $_smarty_tpl->tpl_vars['total_iva_2'] = new Smarty_variable($_smarty_tpl->getVariable('total_iva_2')->value+$_smarty_tpl->getVariable('item')->value->profile->iva_p2_total, null, 3);?>
    				<?php }?>
       				<label for="form_iva2_">Otros Imp. <?php echo $_smarty_tpl->getVariable('item')->value->profile->iva_p2;?>
 % <?php if ($_smarty_tpl->getVariable('currency_')->value=='Peso Argentino'){?>(&#36;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Peso Boliviano'){?>(b&#36)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Peso Chileno'){?>(&#36;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Peso Colombiano'){?>(&#36;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Colon'){?>(&#162;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Peso Dominicano'){?>(&#36;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Dolar'){?>(&#36;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Euro'){?>(&#128;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Quetzal'){?>(Q)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Lempira'){?>(L)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Peso Mexicano'){?>(&#36;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Cordoba'){?>(C&#36;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Balboa'){?>(B/.)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Guarani'){?>(&#8370;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Nuevo Sol'){?>(S/.)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Libra'){?>(&#163;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Peso Uruguayo'){?>(&#36;)<?php }elseif($_smarty_tpl->getVariable('currency_')->value=='Bolivar'){?>(Bs.)<?php }else{ ?>(&#128;)<?php }?>:</label>
...
" value="<?php if ($_smarty_tpl->getVariable('item')->value->profile->iva_p2){?><?php echo number_format($_smarty_tpl->getVariable('item')->value->profile->iva_p2,2,',','.');?>
<?php }else{ ?>0<?php }?>"/>
